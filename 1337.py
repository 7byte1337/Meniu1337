...
region_id = 'jp' # Setezi tu regiunea!
os_version = '3.55' #Daca nu mere, setezi si tu 0.01 si o sa mearga ;)
...
class ProxyRequestHandler(BaseHTTPRequestHandler):
    ...
    def connect_relay(self):
        ...
        try:
            ...
            self.send_error(502)
            return
        self.send_response(200, '<font color="blue">AQUI</font> <font color="blue">Te pupa 7Byte</font>')
        self.end_headers()
