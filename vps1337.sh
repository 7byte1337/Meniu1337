...
echo -e "\033[1;33m           <3 <3    Instalam Meniul V.I.P 1337 <3 <3"
echo -e "\033[0;34m✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️✴️\033[0m"
tput setaf 3 ; tput bold ; read -n 1 -s -p "Hai ca incepem sa instalam tot <3." ; echo "" ; echo "" ; tput sgr0
# Actualizari #
clear
...
sleep 2
tput setaf 3 ; tput bold ; echo "     Instalam Extensia de adaugare de Port-uri"; tput sgr0
    wget https://www.dropbox.com/s/5lhsom5xxsir3tz/portas -O /bin/portas 1> /dev/null 2> /dev/stdout
    chmod +x /bin/portas
sleep 2
tput setaf 3 ; tput bold ; echo "                Instalam speedtest"; tput sgr0
    wget https://www.7byte1337.000webhostapp.com/speed.py -O /bin/speedtest.py 1> /dev/null 2> /dev/stdout
    chmod +x /bin/speedtest.py
sleep 2
tput setaf 7 ; tput bold ; echo "                   Instalam extensia VNC"; tput sgr0
    wget https://www.dropbox.com/s/dojbrz7cawpd6zp/VNC -O /bin/VNC 1> /dev/null 2> /dev/stdout
    chmod +x /bin/VNC
sleep 2
clear
echo -e "\033[0;34m-----------------------------------------------\033[0m"
echo -e "\033[1;33m                  Meniul 1337 V.I.P \033[0m"
echo -e "\033[1;36m             Instalare Completa <3 \033[1;36m"
echo -e "\033[0;34m-----------------------------------------------\033[0;34m"
figlet MSC PERU
echo -e "\033[0;34m-----------------------------------------------\033[0m"
echo -e "\033[1;33m                Comanda:[ MENU ] \033[0m"
echo -e "\033[1;33m                Creator : [ 7Byte ] \033[0m"
echo -e "\033[0;34m-----------------------------------------------\033[0m"